...
def calculate():
    ...
    pctg_bachelors=(df['education']=='Bachelors').mean()*100
    
    #What percentage of people with advanced education (Bachelors, Masters, or Doctorate) make more than 50K?
    adv_edu=df['education'].isin(['Bachelors','Masters','Doctorate'])
    pctg_adv_edu_50k=round((df.loc[adv_edu,'salary']=='>=50k').mean()*100,1)'''
